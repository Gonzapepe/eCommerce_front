    ...
    return (
        <>
            <div id="background_slider" className="w-full md:my-4 m-auto md:mt-20">
                <h1 className="uppercase text-slate-400	font-normal text-2xl text-center my-4" id="categoriesTitle">
                    Envíos
                </h1>

                <div className="w-full relative">
                    <img src={deliveryBack} className="w-full" alt="delivery background"/>
                        ...
                        {deliveryData.map((slide, index) => {
                                return (
                                    <div
                                        key={index}
                                    >
                                        <img src={slide.image} alt='travel' className="w-[50%] m-auto md:w-[100%]" alt="slider"/>
                                    </div>
                                );
                        })}      
                    </AutoplaySlider>
