...
const Categories = () => (
    <>
        <div id="categoriesContainer" className="w-full p-2 md:my-4 m-auto md:mt-20 md:max-w-6xl">
            <h1 className="uppercase text-slate-400	font-normal text-2xl my-4" id="categoriesTitle">
                Categorías
            </h1>

            <div id="CategoriesList" className="w-full m-auto gap-4 grid grid-rows-2 md:grid-cols-2">
                {
